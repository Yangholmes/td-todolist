 ...
 */
require_once( __DIR__.'/../../php/lib/yang-lib/yang-class-http-request.php');
require_once( __DIR__.'/../../php/lib/yang-lib/yang-xml.php');
...
class Auth{
    ...
    public function __construct(){
      $path = __DIR__.'/../../php/config/dd-config.xml';
      if( !is_string($path) )
        return false;
      $this->_instance_http_request();

      $this->_noncestr_rand(); // generate noncestr
      $this->_load_dd_config($path, DEV_MODE); // load config
